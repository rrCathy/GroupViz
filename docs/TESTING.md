...
## 3. 测试文件清单（src/__tests__，38 文件 / 856 tests）
...
| layouts.test.ts | 30 | computeShape2DPositions（12 形状 size=order、circular→null、grid 需直积）、compute2DPositions（17 布局）、compute3DPositions、ringOrder 数字感知排序、computeElementOrder、cayleyCircleLayout（S2-perm 六边形 0 交叉、D2/D4 双环 0 交叉 + 配对断言、V4 未误入双环、直积覆盖） |
