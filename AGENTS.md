...
| [docs/TESTING.md](docs/TESTING.md) | 测试体系：82 文件 1776 tests（node+dom 双项目）、Playwright E2E 13 tests、vitest 配置、覆盖率、测试约定、**法则型性质测试（元素→数学对象映射的 11 条结构法则 oracle）** |
...
GroupViz/
├── src/
│   ├── __tests__/              # 82 个测试文件（1776 tests，node+dom 双项目），见 docs/TESTING.md
│   ├── components/
