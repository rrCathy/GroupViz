...
| [docs/TESTING.md](docs/TESTING.md) | 测试体系：63 文件 1527 tests（node+dom 双项目）、Playwright E2E 13 tests、vitest 配置、覆盖率、测试约定 |
...
GroupViz/
├── src/
│   ├── __tests__/              # 63 个测试文件（1527 tests，node+dom 双项目），见 docs/TESTING.md
│   ├── components/
