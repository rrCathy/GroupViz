...
| [docs/TESTING.md](docs/TESTING.md) | 测试体系：75 文件 1640 tests（node+dom 双项目）、Playwright E2E 13 tests、vitest 配置、覆盖率、测试约定 |
...
GroupViz/
├── src/
│   ├── __tests__/              # 75 个测试文件（1640 tests，node+dom 双项目），见 docs/TESTING.md
│   ├── components/
