...
| [docs/TESTING.md](docs/TESTING.md) | 测试体系：33 文件 659 tests、vitest 配置、覆盖率、测试约定 |
...
GroupViz/
├── src/
│   ├── __tests__/              # 33 个测试文件（659 tests），见 docs/TESTING.md
│   ├── components/
