...
import type { SeriesType, SeriesFactor } from '../../core/algebra/series'
import type {
  CanvasTransform,
  Group,
  GroupElement,
...
export function SeriesPanel({ group, series, color, theme: themeProp }: SeriesPanelProps) {
...
export function SublatticeScene({
  ...
  return (
    ...
    >
      ...
      {showSeriesPanel && series && <SeriesPanel group={group} series={series} color={seriesColor} theme={theme} />}
    </div>
  )
}